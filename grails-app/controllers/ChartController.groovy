...
class ChartController {
    ...
    def basicStatistics = {
        ...
        pw.write("<td valign='top'><div style='position:relative;left:-30px;' class='help'><a  href=\"javascript:showInfo('plugins/rdc-rmodules-0.1/help/boxplot.html');\"><img src=\"../images/information.png\"></a></div></td>"); //Should be dynamic to plugin!
        pw.write("</td><td align='center'>");
        if (s2 && l2.size() > 0) {
    ...
    private void renderConceptAnalysisNew(String concept_key, String result_instance_id1, String result_instance_id2, PrintWriter pw, HttpServletRequest request) {
        ...
        try {
            ...
            if (i2b2HelperService.isValueConceptCode(concept_cd)) {
                ...
                ChartUtilities.writeImageMap(pw, filename, info, false);
                pw.write("</td>");
                pw.write("<td valign='top'><div style='position:relative;left:-10px;' class='help'><a  href=\"javascript:showInfo('plugins/rdc-rmodules-0.1/help/boxplot.html');\"><img src=\"../images/information.png\"></a></div></td>"); //Should be dynamic to plugin!
                pw.write("<td>")
